...
const Index = () => {
  ...
  return (
    <div className="h-screen overflow-y-auto bg-gradient-to-br from-green-50 via-blue-50 to-emerald-50 dark:from-gray-900 dark:via-green-900 dark:to-blue-900">
